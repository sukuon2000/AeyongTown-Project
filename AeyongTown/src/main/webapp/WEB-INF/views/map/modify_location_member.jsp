...
<form action="/user/map/update" method="post" id="updateLocation">
<sec:csrfInput />
	<div class="map_wrap">
...
$(document).ready(function(){
	...
	kakao.maps.load(function() {
		...
		designatedInfoWindow = new kakao.maps.InfoWindow({content: '<div style="width:150px;text-align:center;">원래 위치</div>'});
		// 마커를 지도위에 생성
